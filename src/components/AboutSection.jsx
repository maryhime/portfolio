...
const AboutSection = () => {
  return (
    <div className="flex flex-col tablet:flex-row gap-48 px-24 py-24 phone-lg:px-64 tablet:px-100 laptop:px-100 items-center pt-100 laptop:py-[250px] font-inter ">
