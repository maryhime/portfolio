...
const AboutSection = () => {
  return (
    <div className="flex flex-col tablet:flex-row gap-48 py-100  px-24 phone-lg:px-64 tablet:px-50 laptop-lg:px-100 desktop:px-200  laptop:py-200 items-center  font-inter ">
      ...
      <div className="flex flex-col gap-24 laptop:gap-48 w-full">
        <div className="flex flex-col gap-24 laptop:gap-16">
          ...
          <p className=" text-text-color text-phone-body break-after-all laptop:w-full tablet:text-tablet-body laptop:text-body tablet:text-justify">
