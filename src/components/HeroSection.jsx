      ...
      {ICONS.map((value, index) =>
        <div key={index}  className="flex flex-col gap-48 phone:px-24 phone-lg:px-64 tablet:px-100 laptop:px-100 items-center phone:pt-100 laptop:pt-[250px] min-h-screen">
          ...
          <div className="flex flex-col w-fit phone:gap-16 text-text-color uppercase text-center font-inter">
            <h1 className="phone:text-phone-h1 tablet:text-tablet-h1 laptop:text-h1 text-center ">
              Lorem Ipsum Dolor
            </h1>
            <h4 className='phone:text-phone-h4 tablet:text-tablet-h4'>Lorem ipsum dolor</h4>
          </div>
          ...
          <img src={value['arrow-down']} className='phone:w-[70px] phone:h-[70px] tablet:h-[100px] tablet:w-[100px] animate-bounce' alt="" />
