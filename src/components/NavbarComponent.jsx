...
const NavbarComponent = () => {
  return (
    <div className="w-screen flex flex-row phone:gap-48 phone:px-24 phone:py-24 phone-lg:px-64 tablet:px-100 bg-transparent items-center font-inter ">
      ...
      <div className="phone:flex phone:w-full phone:justify-end  tablet:hidden laptop:hidden">
        {ICONS.map((value, index) =>
          <img className='phone:w- laptop:w-full' key={index} src={value.menu} alt="" />
        )}
      </div>
