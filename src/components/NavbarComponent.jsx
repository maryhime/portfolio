...
const NavbarComponent = () => {
  return (
    <div className="w-screen flex flex-row gap-48 py-24 px-24 phone-lg:px-64 tablet:px-50 laptop-lg:px-100 desktop:px-200  laptop:py-200 bg-transparent items-center font-inter ">
