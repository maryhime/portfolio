...
const CTABlockComponent = () => {
  return (
    <div className="bg-[url('/images/CTA-mobile.svg')] tablet:bg-[url('/images/CTA-bg.svg')] bg-no-repeat bg-cover flex flex-col tablet:flex-row font-inter py-100  px-24 phone-lg:px-64 tablet:px-50 laptop-lg:px-100 desktop:px-200 w-full items-center gap-24 tablet:gap-100">
