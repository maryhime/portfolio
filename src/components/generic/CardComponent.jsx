  ...
  return (
    <>
      {SERVICES.map((value, index) =>
        <div key={index} className="card backdrop-blur-[25px] font-inter text-text-color px-24 laptop:px-48 py-48 rounded-card  w-full">

          <div className="flex flex-col gap-16 tablet:gap-24 items-center w-full" >
            <img className='w-[75px] h-[75px]' src={value.icon} alt="" />
